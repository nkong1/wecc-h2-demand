...
from industry.aggregate_and_plot import aggregate_by_lz, get_demand_grid
...
def model_existing_demand(years):
    ...
    existing_plants_df = get_existing_demand()
    baseline_by_lz = aggregate_by_lz(existing_plants_df)
